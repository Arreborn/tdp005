...
void Archer::tick(sf::Time time, World &world)
{
    Hostile.tick(time, world);
}

void Archer::render(sf::RenderWindow &drawTo)
{
    Hostile.render(drawTo);
}
...
void Archer::horizontalPosition()
{
